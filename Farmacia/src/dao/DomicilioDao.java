...
public class DomicilioDao {
		...
		public Domicilio traerDomicilio( long idDomicilio) throws HibernateException {
		...
		public Domicilio traerDomicilio( String domicilio) throws HibernateException {
			Domicilio objeto = null ;
			try {
				iniciaOperacion();
				objeto = (Domicilio) session.createQuery( "from Domicilio d where d.domicilio="+(domicilio)).uniqueResult();
			} 
			finally {
				session.close();
			}
		...
		public List<Domicilio> traerDomicilio() throws HibernateException {
			...
			try {
				iniciaOperacion();
				lista= session.createQuery( "from Domicilio d order by d.domicilio asc ").list();
			} 	finally {
				session.close();
				}
			return lista;
