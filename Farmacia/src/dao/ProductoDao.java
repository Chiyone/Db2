...
public class ProductoDao {
		...
		public Producto traerProducto( String producto) throws HibernateException {
			Producto objeto = null ;
			try {
				iniciaOperacion();
				objeto = (Producto) session.createQuery( "from Producto p where p.producto="+(producto)).uniqueResult();
			} 
			finally {
				session.close();
			}
